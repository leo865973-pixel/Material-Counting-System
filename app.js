...
// 🌟 關鍵修復：從 window 中把所有共用元件與資料提取出來，讓 app.js 可以使用
const {
  hashPassword, playEdgeTTS, db, storage,
  MOCK_USERS, MOCK_TAGS, MOCK_TASKS, MOCK_MATERIALS,
  Icon, Badge, Button, Input, Card, Modal, showToast, ToastContainer
} = window;
